    ...
    <Section title="Active Time">
      <SubSection>
        <p>
          ...
          casting or inside of a global cooldown. Mistweaver is a high APM spec, so every second
          spent idle is potential healing lost. Fill movement with instant casts like{' '}
          ...
          <SpellLink spell={TALENTS_MONK.ENVELOPING_MIST_TALENT} /> while on the move. Dipping
          during downtime is ok, but globals should still be used with <i>anything</i> rather than{' '}
          <i>nothing</i>.
        </p>
        <GuideDataWrapper
          title="Timeline"
