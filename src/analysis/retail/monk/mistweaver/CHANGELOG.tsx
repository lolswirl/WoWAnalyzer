...
// prettier-ignore
export default [
  change(date(2026, 9, 15), <>Added <SpellLink spell={TALENTS_MONK.MEDITATIVE_FOCUS_TALENT}/> and <SpellLink spell={TALENTS_MONK.YULONS_KNOWLEDGE_TALENT}/> modules.</>, swirl),
