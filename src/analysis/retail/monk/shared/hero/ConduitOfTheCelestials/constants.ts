...
export const TEMPLE_TRAINING_INCREASE = 0.06;
export const XUENS_GUIDANCE_REFUND_CHANCE = 0.15;
export const XUENS_GUIDANCE_TP_INCREASE = 0.1;
export const FLOWING_WISDOM_HASTE = 0.1;
export const INNER_COMPASS_STAT_INCREASE = 0.02;
export const PATH_OF_THE_FALLING_STAR_INCREASE = 1.0;
export const PATH_OF_THE_FALLING_STAR_REDUCTION_PER_TARGET = 0.2;
